...
import { ASTNodeBase, BIND_KEY, Context, findLabeledStatement, forEach, getOutputNode, patchPlaceholderPorts, ToASTContext } from '../../../core'
import { BaseNode, Output } from '../../../nodes'
import { Schemes } from '../../../types'
import { removeNodeWithConnections } from '../../../utils'
import { Transformer } from './interface'
import { Connection } from '../../../connections'
import { getClosureDifferenceOld } from '../../../core/elaborate'
...
export class OmitLabeled<ASTNode extends ASTNodeBase, S extends Schemes> extends Transformer<Context<ASTNode, S>, ToASTContext<ASTNode, S>> {
  ...
  async up(context: Context<ASTNode, S>) {
    await (forEach<ASTNode, S>(n => n.label === 'LabeledStatement', async (node, context) => {
      ...
      await removeNodeWithConnections(editor, labelNode.id)
